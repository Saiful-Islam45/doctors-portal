...
const AppointmentModal = (props) => {
  ...
  const onSubmit = (data, e) => {
    ...
    console.log(newData);
    fetch('https://doctors-portal-saiful.herokuapp.com//updateAppointment', {
            method: 'POST',
            headers: {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-group col-6">
                ...
                <div defaultValue={appointment.name} className="form-group">
                  <input defaultValue={appointment.name} type="text" className="form-control text-uppercase" name="name" placeholder="your name" ref={register({ required: true })} />
