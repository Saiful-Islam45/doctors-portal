...
const DoctorAppointment = (props) => {
    ...
    return (
            ...
            <div className="col-md-5 ml-5 ml-3">
               
                <div style={{ backgroundColor: "#fff" }} className="my-5 ml-1">
                    <div className="d-flex">
                        <h4>Appointment</h4>
                        <h5 className="pl-4">{props.date?props.date:date}</h5>
                    </div>
                    <table id="patientsTable" className="table border-0 ml-4">
