...
const PatientModal = (props) => {
  ...
  const onSubmit = (data,e) => { 
    fetch('https://doctors-portal-saiful.herokuapp.com/addPatient', {
            method: 'POST',
            headers: {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="form" id="form">
                <div className="form-group">
                  <input defaultValue={props.appointment.name} type="text" className="form-control text-uppercase" name="name" placeholder="your name" ref={register({required: true })} />
...
// import cardData from '../../resources/patientsData.json';
...
//         fetch('http://localhost:5200/addPatient',{
//             method:'POST',
...
//             <h1>Add  Data</h1>
//             <button className="btn btn-info p-2" onClick={handleAddInventory}>Add Patient</button>
//         </div>
//     );
// };
// export default PatientModal;
